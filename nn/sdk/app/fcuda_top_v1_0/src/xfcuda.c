...
void XFcuda_SetD_locations_addr(XFcuda *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XFcuda_WriteReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_D_LOCATIONS_ADDR_DATA, Data);
}

u32 XFcuda_GetD_locations_addr(XFcuda *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XFcuda_ReadReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_D_LOCATIONS_ADDR_DATA);
    return Data;
}

void XFcuda_SetD_distances_addr(XFcuda *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XFcuda_WriteReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_D_DISTANCES_ADDR_DATA, Data);
}

u32 XFcuda_GetD_distances_addr(XFcuda *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XFcuda_ReadReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_D_DISTANCES_ADDR_DATA);
    return Data;
}

void XFcuda_SetNumrecords(XFcuda *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XFcuda_WriteReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_NUMRECORDS_DATA, Data);
}

u32 XFcuda_GetNumrecords(XFcuda *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XFcuda_ReadReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_NUMRECORDS_DATA);
    return Data;
}

void XFcuda_SetLat(XFcuda *InstancePtr, float Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    //XFcuda_WriteReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_LAT_DATA, Data);
    *(volatile float*)((InstancePtr->Axi4lites_BaseAddress) + (XFCUDA_AXI4LITES_ADDR_LAT_DATA)) = (float)(Data);

}

float XFcuda_GetLat(XFcuda *InstancePtr) {
    float Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    //Data = XFcuda_ReadReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_LAT_DATA);
    Data = *(volatile float*)((InstancePtr->Axi4lites_BaseAddress) + (XFCUDA_AXI4LITES_ADDR_LAT_DATA));
    return Data;
}

void XFcuda_SetLng(XFcuda *InstancePtr, float Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    //XFcuda_WriteReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_LNG_DATA, Data);
    *(volatile float*)((InstancePtr->Axi4lites_BaseAddress) + (XFCUDA_AXI4LITES_ADDR_LNG_DATA)) = (float)(Data);
}

float XFcuda_GetLng(XFcuda *InstancePtr) {
    float Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    //Data = XFcuda_ReadReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_LNG_DATA);
    Data = *(volatile float*)((InstancePtr->Axi4lites_BaseAddress) + (XFCUDA_AXI4LITES_ADDR_LNG_DATA));
    return Data;
}
