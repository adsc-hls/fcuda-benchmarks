...
// includes, common
//*V* #include <cmd_arg_reader.h>
#include "error_checker.h"
//*V* #include <stopwatch.h>
//*V* #include <bank_checker.h>
...
////////////////////////////////////////////////////////////////////////////////
//*V* CUTBoolean CUTIL_API
//*V* cutCheckCmdLineFlag( const int argc, const char** argv, const char* flag_name) 
//*V* {
//*V*     CUTBoolean ret_val = CUTFalse;
//*V* 
//*V*     try 
//*V*     {
//*V*         // initalize 
//*V*         CmdArgReader::init( argc, argv);
//*V* 
//*V*         // check if the command line argument exists
//*V*         if( CmdArgReader::existArg( flag_name)) 
//*V*         {
//*V*             ret_val = CUTTrue;
//*V*         }
//*V*     }
//*V*     catch( const std::exception& /*ex*/) 
//*V*     {    
//*V*         std::cerr << "Error when parsing command line argument string." << std::endl;
//*V*     } 
//*V* 
//*V*     return ret_val;
//*V* }
...
////////////////////////////////////////////////////////////////////////////////
//*V* CUTBoolean CUTIL_API
//*V* cutGetCmdLineArgumenti( const int argc, const char** argv, 
//*V*                         const char* arg_name, int* val) 
//*V* {
//*V*     CUTBoolean ret_val = CUTFalse;
//*V* 
//*V*     try 
...
//*V* 
//*V*         // access argument
//*V*         const int* v = CmdArgReader::getArg<int>( arg_name);
//*V*         if( NULL != v) 
//*V*         {
//*V*             // assign value
//*V*             *val = *v;
...
////////////////////////////////////////////////////////////////////////////////
//*V* CUTBoolean CUTIL_API
//*V* cutGetCmdLineArgumentf( const int argc, const char** argv, 
//*V*                        const char* arg_name, float* val) 
//*V* {
//*V*     CUTBoolean ret_val = CUTFalse;
//*V* 
//*V*     try 
...
//*V* 
//*V*         // access argument
//*V*         const float* v = CmdArgReader::getArg<float>( arg_name);
//*V*         if( NULL != v) 
//*V*         {
//*V*             // assign value
//*V*             *val = *v;
...
////////////////////////////////////////////////////////////////////////////////
//*V* CUTBoolean CUTIL_API
//*V* cutGetCmdLineArgumentstr( const int argc, const char** argv, 
//*V*                          const char* arg_name, char** val) 
//*V* {
//*V*     CUTBoolean ret_val = CUTFalse;
//*V* 
//*V*     try 
...
//*V* 
//*V*         // access argument
//*V*         const std::string* v = CmdArgReader::getArg<std::string>( arg_name);
//*V*         if( NULL != v) 
//*V*         {
//*V* 
//*V*             // allocate memory for the string
//*V*             *val = (char*) malloc( sizeof(char) * (v->length() + 1));
//*V*             // copy from string to c_str
//*V*             strcpy( *val, v->c_str());
//*V*             ret_val = CUTTrue;
//*V*         }		
//*V* 		else {
//*V* 			// fail safe
...
//*V*     catch( const std::exception& /*ex*/) 
//*V*     {    
//*V*         std::cerr << "Error when parsing command line argument string."<< 
//*V*         std::endl;
//*V*     } 
//*V* 
//*V*     return ret_val;
...
////////////////////////////////////////////////////////////////////////////////
//*V* CUTBoolean CUTIL_API
//*V* cutCreateTimer( unsigned int* name) 
//*V* {
//*V*     *name = StopWatch::create();
//*V* 
//*V*     return (0 != name) ? CUTTrue : CUTFalse;
//*V* }
...
////////////////////////////////////////////////////////////////////////////////
//*V* CUTBoolean CUTIL_API
//*V* cutDeleteTimer( unsigned int name) 
//*V* {
//*V*     CUTBoolean retval = CUTTrue;
//*V* 
//*V*     try 
//*V*     {
//*V*         StopWatch::destroy( name);
//*V*     }
//*V*     catch( const std::exception& ex) 
//*V*     {
//*V*         std::cerr << "WARNING: " << ex.what() << std::endl;
//*V*         retval = CUTFalse;
//*V*     }
//*V* 
//*V*     return retval;
...
////////////////////////////////////////////////////////////////////////////////
//*V* CUTBoolean CUTIL_API
//*V* cutStartTimer( const unsigned int name) 
//*V* {
//*V*     CUTBoolean retval = CUTTrue;
//*V* 
//*V* #ifdef _DEBUG
...
////////////////////////////////////////////////////////////////////////////////
//*V* CUTBoolean CUTIL_API
//*V* cutStopTimer( const unsigned int name) 
//*V* {
//*V*     CUTBoolean retval = CUTTrue;
//*V* 
//*V* #ifdef _DEBUG
...
////////////////////////////////////////////////////////////////////////////////
//*V* CUTBoolean CUTIL_API
//*V* cutResetTimer( const unsigned int name)
//*V* {
//*V*     CUTBoolean retval = CUTTrue;
//*V* 
//*V* #ifdef _DEBUG
...
////////////////////////////////////////////////////////////////////////////////
//*V* float CUTIL_API
//*V* cutGetAverageTimerValue( const unsigned int name)
//*V* {
//*V*     float time = 0.0;
//*V* 
//*V* #ifdef _DEBUG
//*V*     try 
//*V*     {
//*V*         time = StopWatch::get( name).getAverageTime();
//*V*     }
//*V*     catch( const std::exception& ex) 
//*V*     {
//*V*         std::cerr << "WARNING: " << ex.what() << std::endl;
...
////////////////////////////////////////////////////////////////////////////////
//*V* float CUTIL_API
//*V* cutGetTimerValue( const unsigned int name) 
//*V* {  
//*V*     float time = 0.0;
//*V* 
//*V* #ifdef _DEBUG
//*V*     try 
//*V*     {
//*V*         time = StopWatch::get( name).getTime();
//*V*     }
//*V*     catch( const std::exception& ex) 
//*V*     {
//*V*         std::cerr << "WARNING: " << ex.what() << std::endl;
...
////////////////////////////////////////////////////////////////////////////////
//*V* void CUTIL_API
//*V* cutCheckBankAccess( unsigned int tidx, unsigned int tidy, unsigned int tidz,
//*V*                    unsigned int bdimx, unsigned int bdimy, unsigned int bdimz,
//*V*                    const char* file, const int line, const char* aname,
//*V*                    const int index) 
//*V* {
//*V*     BankChecker::getHandle()->access( tidx, tidy, tidz, 
//*V*                                       bdimx, bdimy, bdimz,
//*V*                                       file, line, aname, index );
//*V* }
//*V* 
