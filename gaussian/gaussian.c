...
void InitPerRun();
void ForwardSub(float *m, float *a, float *b);
void BackSub();
void Fan1(float *m, float *a, int Size, int t, dim3 dimGrid, dim3 dimBlock, int num_cores, int core_id);
void Fan2(float *m, float *a, float *b,int Size, int j1, int t, dim3 dimGrid, dim3 dimBlock, int num_cores, int core_id);
