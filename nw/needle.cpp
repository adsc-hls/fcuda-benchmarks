...
void runTest( int argc, char** argv)
{
  ...
  for( int i = 1 ; i <= block_width ; i++){
    ...
    //needle_cuda_shared_1(referrence_cuda, matrix_cuda, matrix_cuda_out, max_cols, penalty, i, block_width, dimGrid, dimBlock);
    needle_cuda_shared_1(referrence_cuda, matrix_cuda, max_cols, penalty, i, block_width, dimGrid, dimBlock, 1, 0);
  }
  ...
  for( int i = block_width - 1  ; i >= 1 ; i--){
    ...
    //                                      ,max_cols, penalty, i, block_width);
    //needle_cuda_shared_2(referrence_cuda, matrix_cuda, matrix_cuda_out
    //                                      ,max_cols, penalty, i, block_width, dimGrid, dimBlock);
    needle_cuda_shared_2(referrence_cuda, matrix_cuda
        ,max_cols, penalty, i, block_width, dimGrid, dimBlock, 1, 0);
