...
void XFcuda_SetAtomdata_addr(XFcuda *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XFcuda_WriteReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_ATOMDATA_ADDR_DATA, Data);
}

u32 XFcuda_GetAtomdata_addr(XFcuda *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XFcuda_ReadReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_ATOMDATA_ADDR_DATA);
    return Data;
}

void XFcuda_SetNumatoms(XFcuda *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XFcuda_WriteReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_NUMATOMS_DATA, Data);
}

u32 XFcuda_GetNumatoms(XFcuda *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XFcuda_ReadReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_NUMATOMS_DATA);
    return Data;
}

void XFcuda_SetGridspacing(XFcuda *InstancePtr, float Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    //XFcuda_WriteReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_GRIDSPACING_DATA, Data);
    *(volatile float*)((InstancePtr->Axi4lites_BaseAddress) + (XFCUDA_AXI4LITES_ADDR_GRIDSPACING_DATA)) = (float)(Data);
}

float XFcuda_GetGridspacing(XFcuda *InstancePtr) {
    float Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    //Data = XFcuda_ReadReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_GRIDSPACING_DATA);
    Data = *(volatile float*)((InstancePtr->Axi4lites_BaseAddress) + (XFCUDA_AXI4LITES_ADDR_GRIDSPACING_DATA));
    return Data;
}

void XFcuda_SetEnergygrid_addr(XFcuda *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XFcuda_WriteReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_ENERGYGRID_ADDR_DATA, Data);
}

u32 XFcuda_GetEnergygrid_addr(XFcuda *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XFcuda_ReadReg(InstancePtr->Axi4lites_BaseAddress, XFCUDA_AXI4LITES_ADDR_ENERGYGRID_ADDR_DATA);
    return Data;
}
